...
export const ScaleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 20.25a7.5 7.5 0 1 0-13.5 0M18.75 20.25v-7.5A7.5 7.5 0 0 0 12 5.25v-2.25" />
    </svg>
);
...
export const ReceiptPercentIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 15.91a.375.375 0 0 1 .53 0l.09.09a.375.375 0 0 1 0 .53l-4.49 4.49a.375.375 0 0 1-.53 0l-.09-.09a.375.375 0 0 1 0-.53l4.49-4.49Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.13 10.13a.375.375 0 0 1 .53 0l.09.09a.375.375 0 0 1 0 .53l-4.49 4.49a.375.375 0 0 1-.53 0l-.09-.09a.375.375 0 0 1 0-.53l4.49-4.49Z" />
    </svg>
);
...
export const DocumentMinusIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m-1.5 6-3.75 3.75m0 0A2.25 2.25 0 0 1 3 18.75V10.5c0-1.242 1.008-2.25 2.25-2.25H9M7.5 15h6" />
    </svg>
);
...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg aria-hidden="true" className={className || "w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-sky-600"} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
